...
${fragmentShader}`;
  ...
  const { assign: assign$3, assignIf } = troikaCore.utils;
  ...
  function makeWorldTextureProvider(WrappedFacadeClass) {
    ...
    return class WorldTextureProvider extends WrappedFacadeClass {
      constructor(parent) {
        const texture = new three.CanvasTexture(); //no canvas yet, will be added in first afterUpdate()
  ...
  const geometries = Object.create(null, [
    ...
    descr[name] = {
      get: troikaCore.utils.memoize(() =>
        new three.CircleBufferGeometry(1, segments).rotateX(-Math.PI / 2)
      )
    };
    return descr
  }, {}));
  ...
  const geometries$1 = Object.create(null, [
    ...
    descr[name] = {
      get: troikaCore.utils.memoize(() => new three.SphereBufferGeometry(1, wSegs, hSegs))
    };
    return descr
  }, {}));
